    ...
    if partition == 'pat':
        ...
        for i in range(num_classes):
            ...
            if balance:
                ...
                num_samples = np.random.randint(num_per/2.7, num_per*1.6, num_selected_clients-1).tolist()
...
def save_file(config_path, train_path, test_path, train_data, test_data, num_clients, 
                num_classes, statistic, niid=False, balance=True, partition=None, extra_config=None):
    config = {
